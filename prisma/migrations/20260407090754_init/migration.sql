...
CREATE TABLE `Submission` (
    ...
    `student_id` BIGINT NOT NULL,
    `text_content` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `SubmissionImages` ADD CONSTRAINT `SubmissionImages_submission_id_fkey` FOREIGN KEY (`submission_id`) REFERENCES `Submission`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
